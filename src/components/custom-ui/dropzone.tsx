  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="fixed inset-0 border-4 border-dashed border-emerald-400 pointer-events-none rounded-sm"
      />
        ...
        {!hasFiles ? (
          <motion.div
            ...
            className={`relative border-2 border-dashed rounded-3xl p-16 text-center cursor-pointer w-full max-w-lg transition-all duration-300 ${
              isDragging
                ? "border-emerald-400 bg-emerald-50 dark:bg-emerald-950/30 shadow-inner shadow-emerald-100 dark:shadow-emerald-900/30"
                : "border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:border-emerald-300 dark:hover:border-emerald-700 hover:shadow-md hover:shadow-emerald-50 dark:hover:shadow-emerald-950/30"
            }`}
            ...
            <div className="flex flex-col items-center justify-center space-y-5">
              <motion.div
                ...
                className={`p-5 rounded-2xl transition-colors ${
                  isDragging
                    ? "bg-emerald-100 dark:bg-emerald-900/50 text-emerald-600 dark:text-emerald-400 shadow-lg shadow-emerald-200/50 dark:shadow-emerald-900/50"
